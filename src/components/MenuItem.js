      ...
      <div className="itemContainer">
        <div className="leftContainer">
          <div className="imgContainer">
            ...
            <img src={this.props.foodImage} alt={this.props.itemName} />
          </div>
        ...
        <div className="rightContainer">
          ...
          <div
            id="favorite"
            className={
              this.state.handleClickFavorite ? "isFavorite" : "notFavorite"
            }
            onClick={(event) => {
              const newFavorite = !this.state.handleClickFavorite;
              this.setState({ handleClickFavorite: newFavorite });
            }}
          ></div>
        </div>
      </div>
